...
def get_arguments():
    ...
    # Hyperparameters
    parser.add_argument( "--batch-size",      type=int,   default=12,   help="The batch size. Default: 10")
    parser.add_argument( "--val-batch-size",  type=int,   default=12,   help="The batch size. Default: 10")
    ...
    # Dataset
    parser.add_argument( "--dataset",        choices=['camvid', 'cityscapes','ritscapes','kitti'],  default='cityscapes', help="Dataset to use. Default: cityscapes")
    ...
    parser.add_argument( "--width",          type=int,        default=512,                          help="The image width. Default: 600")
    ...
    # Settings
    parser.add_argument( "--workers",      type=int,            default=12,            help="Number of subprocesses to use for data loading. Default: 10")
    # Storage settings
