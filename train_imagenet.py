...
def main():
    ...
    model = ERFNet(num_classes=1000,only_encode=True).cuda()
    ...
    for epoch in range(0, NUM_EPOCHS):
        ...
        print('>>>> Epoch:', epoch,' loss: ',epoch_loss, '| Train Accuracy: ', train_acc)

        val_loss, val_acc = run_val_epoch(epoch,model,criterion,optimizer,lr_updater,val_loader)

        print('>> Epoch:',epoch,' loss: ',val_loss, '| Val Accuracy: ', val_acc)
